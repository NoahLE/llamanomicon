...
| Tech Standards           | Uses HeroUI (not custom primitives), Zustand 5 + Immer 11, localStorage persist, Vitest + RTL; `@/` alias for all intra-src imports | [ ]    |
| V1 Scope Gate            | No node graph, no GSAP in this feature; neoskeumorphic styling is permitted                                                         | [ ]    |
